...
import SuperRetroMapScene from './scenes/SuperRetroMapScene.js';
const config = {
  type: Phaser.AUTO,
  width: 1024,
  height: 768,
  ...
  scene: [BootScene, ArtifactPickScene, HubScene, OverworldScene, DeckSelectScene, BattleScene, DeckBuilderScene, MasterModeScene, CraftingScene, MmoMapScene, PvpBattleScene, YakuzaHideoutScene, TutorialScene, SuperRetroMapScene]
};
